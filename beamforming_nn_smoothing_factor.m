function [y,qout] = beamforming_nn_smoothing_factor(sig,air,pp)
    ...
    for iFrame = 1:nFrame
        ...
        if noi_flg
            ...
            qq.ryy = ryy;
            qq.mask = msk(:,iFrame);
            [rvv,qq] = estnoicov_nn(sigFFT,rvv,qq);     
            rvvMat(:,:,:,iFrame) = rvv;
        end
